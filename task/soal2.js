...
const productCodeTarget = "FBR00040101"; 
const total = hitungTotalQuantity(productCodeTarget);

console.log(`Total quantity pada code product ${productCodeTarget} adalah: ${total}`);
